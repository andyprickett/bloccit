...
*/
        request.get({ // mock authentication
          url: "http://localhost:3000/auth/fake",
          form: {
            role: "member", //user.role, // mock authenticate as member user
            userId: this.user.id //,
            //email: user.email
          }
        },
...
//      });
  ...
  // new user who does not own the post, so shouldn't be able to
  // edit, update, or destroy it
  describe("new member (non-owner) user performing CRUD actions for Post", () => { 
